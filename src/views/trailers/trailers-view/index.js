...
import { deleteTrailer, loadTrailers } from 'store/actions/trailers';
...
const TrailersView = () => {
    ...
    //SELECTORS
    const trailers = useSelector((state) => state.trailers.list);
    const loading = useSelector((state) => state.trailers.loading);

    //STATES
    const [searched, setSearched] = useState('');
    const [open, setOpen] = useState(false);
    const [list, setList] = useState(trailers);
    ...
    const handleClickView = (id) => {
        return navigate(`/trailer/${id}/`);
    };

    //FUNCTIONS
    const requestSearch = (e) => {
        setSearched(e.target.value);
        const filteredRows = trailers.filter((row) => {
    ...
    return (
        <MainCard title="Manage Trailers">
            ...
            <TableContainer component={Paper} sx={{ maxHeight: 440 }}>
                <Table id="table_trailers" stickyHeader sx={{ minWidth: 700 }} aria-label="customized table">
                    <TableHead>
                        <TableRow>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Are you sure you want to permanently delete this Trailer?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button
