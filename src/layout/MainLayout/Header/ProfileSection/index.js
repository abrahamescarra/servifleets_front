    ...
    return (
        <>
            <Chip
                ...
                label={<IconSettings stroke={1.5} size="1.5rem" color={darkMode ? theme.palette.grey['50'] : theme.palette.primary.main} />}
                variant="outlined"
                ref={anchorRef}
                aria-controls={open ? 'menu-list-grow' : undefined}
                aria-haspopup="true"
                            ...
                            <ClickAwayListener onClickAway={handleClose}>
                                <MainCard border={true} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                    ...
                                    <Box sx={{ pb: 2, px: 2 }}>
                                        <Card
                                            sx={{
                                                bgcolor: darkMode ? theme.palette.secondary.main : theme.palette.secondary.light,
                                                mb: 2
                                            }}
                                        >
                                            <CardContent>
